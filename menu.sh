...
#Usage example
# test_options=("yes" "no" "maybe")
# singleselect test_result test_options
#
### Returns the string value of the selected options
# echo $test_result
...
function singleselect {
	...
	#create enough space for the options
    for ((i=0; i<${#options[@]}; i++)); do
        printf "\n"
    done
    ...
    eval $return_value=${options[active]}
}
